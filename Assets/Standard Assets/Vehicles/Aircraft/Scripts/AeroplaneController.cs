...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    {
        [SerializeField] private float m_MaxEnginePower = 30f;        // The maximum output of the engine.
        [SerializeField] private float m_Lift = 0.002f;               // The amount of lift generated by the aeroplane moving forwards.
        [SerializeField] private float m_ZeroLiftSpeed = 150f;         // The speed at which lift is no longer applied.
